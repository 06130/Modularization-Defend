...
/**
 * 与门节点——所有输入均为 true 时输出 true，否则输出 false。
 *
 * <h3>选项</h3>
 ...
 *   <li><b>输出 result (bool)</b> — 与运算结果</li>
 * </ul>
 */
@NodeAttribute(name = "与门", group = "逻辑", graphTypes = {TurretLogicGraph.class})
public class AndGateNode extends Node {

    @Override
    public Component getDisplayName() {
        return Component.translatable("node.modularization_defend.and_gate");
    }
