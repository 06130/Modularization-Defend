 ...
 */
public class ElectricityRepeaterBlockEntity extends AbstractMultiblockBlockEntity implements GeoBlockEntity {
    private int value;
    ...
    protected AbstractMultiblock getMultiblock() {
        return ElectricityRepeaterMultiblockDef.getInstance();
    }
